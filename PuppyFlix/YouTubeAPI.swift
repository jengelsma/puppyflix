...
class YouTubeAPI : VideoAPI {
    ...
    static let url : String = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=30&type=youtube%23video&key=AIzaSyD1XU4ZU1-j13MYNYCHp2eNFFMpVOPF9-c"
